...
config_1.task("initialize-" + StakedAave, "Initialize the " + StakedAave + " proxy contract")
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var stakedAaveImpl, stakedAaveProxy, encodedInitializeStakedAave, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _c.sent();
                    if (!aaveAdmin) {
                        throw new Error("Missing --admin parameter to add the Admin Role to " + StakedAave + " Transparent Proxy");
                    }
...
//# sourceMappingURL=initialize-StakedAave.js.map