...
export var logAaveTokenBalanceOf = function (account, aaveToken) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                _b = (_a = console).log;
                _c = "[aaveToken.balanceOf(" + account + ")]: ";
                return [4 /*yield*/, aaveToken.balanceOf(account)];
            case 1:
                _b.apply(_a, [_c + (_d.sent()).toString()]);
                return [2 /*return*/];
        }
    });
}); };
export var logStakedAaveBalanceOf = function (staker, stakedAave) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                _b = (_a = console).log;
                _c = "[stakedAave.balanceOf(" + staker + ")]: ";
                return [4 /*yield*/, stakedAave.balanceOf(staker)];
            case 1:
                _b.apply(_a, [_c + (_d.sent()).toString()]);
                return [2 /*return*/];
        }
...
export var logGetStakeTotalRewardsBalance = function (staker, stakedAave) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                _b = (_a = console).log;
                _c = "[stakedAave.getTotalRewardsBalance(" + staker + ")]: ";
                return [4 /*yield*/, stakedAave.getTotalRewardsBalance(staker)];
            case 1:
                _b.apply(_a, [_c + (_d.sent()).toString()]);
                return [2 /*return*/];
        }
...
export var logRewardPerStakedAave = function (stakedAave) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                _b = (_a = console).log;
                _c = "[stakedAave.getRewardPerStakedAave()]: ";
                return [4 /*yield*/, stakedAave.getRewardPerStakedAave()];
            case 1:
                _b.apply(_a, [_c + (_d.sent()).toString()]);
                return [2 /*return*/];
        }
