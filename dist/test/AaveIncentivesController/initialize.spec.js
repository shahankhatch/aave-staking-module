...
make_suite_1.makeSuite('AaveIncentivesController initialize', function (testEnv) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, expect(aaveIncentivesController.initialize()).to.be.reverted];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('allowance on aave token should be granted to psm contract for pei', function () { return __awaiter(void 0, void 0, void 0, function () {
        var aaveIncentivesController, stakedAave, aaveToken, _a;
